...
export default async function VocabLessonPage({ params }: PageProps) {
  ...
  const [lesson, user] = await Promise.all([
    db.vocabLesson.findUnique({
      where: { id: lessonId },
      include: { unit: { select: { id: true, title: true, jlptLevel: true } } },
    }),
    db.user.findUnique({
