  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-semibold text-zinc-900">Vocab Units</h2>
            ...
            <tbody className="divide-y divide-zinc-100">
              {units.map((unit) => (
                <tr key={unit.id} className="hover:bg-zinc-50">
                  ...
                  <td className="px-4 py-3 font-medium text-zinc-700" style={{ fontFamily: "'Noto Sans JP', sans-serif" }}>
                    {unit.titleJa}
                  </td>
