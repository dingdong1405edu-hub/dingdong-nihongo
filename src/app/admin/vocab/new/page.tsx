...
export default function NewVocabUnitPage() {
  ...
  return (
    <div className="max-w-lg space-y-5">
      <div>
        <h2 className="text-xl font-semibold text-zinc-900">Thêm Vocab Unit</h2>
        <p className="mt-0.5 text-sm text-zinc-500">Tạo unit mới cho JLPT vocabulary</p>
      </div>
